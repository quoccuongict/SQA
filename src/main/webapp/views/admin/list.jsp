...
<body class="no-skin">
	...
	<div class="main-container" id="main-container">
    	...
    	<div class="main-content">
			<form action="<c:url value='/admin-insurrance'/>" id="formSubmit" method="get">
							...
							<div class="row">
								<div class="col-xs-12">
									<div class="form-group">
		                                <label class="col-sm-3 control-label no-padding-right">Nơi đăng kí khám chữa bệnh</label>
		                                <div class="col-sm-3">
		                                    <input type="text" class="form-control" id="keyword" name="keyword" value="${keyword}"/>
		                                </div>
		                                <input type="submit" class="btn btn-white btn-warning btn-bold" value="Tìm kiếm" id="btnSearch"/>
		                            </div>
										...
										<div class="col-xs-12">
											<div class="table-responsive">
												<table class="table table-bordered">
													...
													<tbody>
													<c:forEach var="item" items="${insurances}" varStatus="theCount">
														<tr>
